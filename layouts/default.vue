...
<style lang="scss">
@import url("https://p.typekit.net/p.css?s=1&k=pwo8bya&ht=tk&f=24561.24571.28150.28747.28754.28756.28759.28762.29225.29226.44907&a=40077772&app=typekit&e=css");

@font-face {
  font-family:"filson-pro";
  src:url("https://use.typekit.net/af/c12453/0000000000000000000157bf/27/l?subset_id=2&fvd=n7&v=3") format("woff2"),url("https://use.typekit.net/af/c12453/0000000000000000000157bf/27/d?subset_id=2&fvd=n7&v=3") format("woff"),url("https://use.typekit.net/af/c12453/0000000000000000000157bf/27/a?subset_id=2&fvd=n7&v=3") format("opentype");
...
@font-face {
  font-family:"henderson-slab-basic";
  src:url("https://use.typekit.net/af/c16b6b/00000000000000007735b1e4/30/l?subset_id=2&fvd=n7&v=3") format("woff2"),url("https://use.typekit.net/af/c16b6b/00000000000000007735b1e4/30/d?subset_id=2&fvd=n7&v=3") format("woff"),url("https://use.typekit.net/af/c16b6b/00000000000000007735b1e4/30/a?subset_id=2&fvd=n7&v=3") format("opentype");
  font-display:auto;font-style:normal;font-weight:700;
}
